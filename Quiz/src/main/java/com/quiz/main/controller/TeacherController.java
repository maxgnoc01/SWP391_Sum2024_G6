...
public class TeacherController {
	...
	public String createQuiz(@ModelAttribute Quiz quiz, RedirectAttributes redirectAttributes) {
		...
		return "redirect:/teacher/quizzes/" + savedQuiz.getId() + "/questions/new";
	}
	...
	public String addQuestionToQuiz(@PathVariable Long quizId, @ModelAttribute Question question,
			RedirectAttributes redirectAttributes) {
		Quiz quiz = quizService.getQuizById(quizId);
		question.setQuiz(quiz);
		questionService.saveQuestion(question);
		redirectAttributes.addFlashAttribute("message", "Question added successfully!");
		return "redirect:/teacher/quizzes/" + quizId + "/questions/new";
	}
...
// Inside teacherQuizController
	...
	public String updateQuestion(@PathVariable Long id, @ModelAttribute Question question,
		...
		return "redirect:/teacher/quizzes/" + existingQuestion.getQuiz().getId() + "/questions";
	}
	...
	// Implement other teacher endpoints as needed
}
